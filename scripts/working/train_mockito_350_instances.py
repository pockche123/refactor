#!/usr/bin/env python3
"""
Train Mockito ML model on 350-instance dataset
"""
...
def main():
    print("🚀 MOCKITO ML TRAINING (350 INSTANCES)")
    print("=" * 50)
    
    # Load 350-instance dataset
    print("📊 Loading Mockito 350-instance dataset...")
    df = pd.read_csv('data/mockito_simple_dataset_350.csv')
    ...
    print("💾 Saving model...")
    joblib.dump(rf, 'models/mockito_rf_model_350.pkl')
    joblib.dump(le_file, 'models/mockito_file_encoder_350.pkl')
    print("   ✅ models/mockito_rf_model_350.pkl")
    print("   ✅ models/mockito_file_encoder_350.pkl")
    ...
    results_file = 'results/working/mockito_ml_test_results_350.csv'
    results_df.to_csv(results_file, index=False)
    print(f"   ✅ {results_file}")
    
    # Detailed results
    print(f"\n📈 MOCKITO 350-INSTANCE RESULTS:")
