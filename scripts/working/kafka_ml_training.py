...
def load_kafka_dataset():
    """Load Kafka dataset"""
    return pd.read_csv('data/kafka_simple_dataset.csv')
...
def main():
    print("🚀 APACHE KAFKA ML TRAINING")
    print("=" * 50)
    
    # Load dataset
    print("📊 Loading Kafka dataset...")
    df = load_kafka_dataset()
    ...
    print("💾 Saving model...")
    joblib.dump(rf, 'models/kafka_rf_model.pkl')
    joblib.dump(le_file, 'models/kafka_file_encoder.pkl')
    print("   ✅ models/kafka_rf_model.pkl")
    print("   ✅ models/kafka_file_encoder.pkl")
    ...
    results_file = 'results/working/kafka_ml_test_results.csv'
    results_df.to_csv(results_file, index=False)
    print(f"   ✅ {results_file}")
    
    # Summary for comparison with other projects
    print(f"\n🎯 APACHE KAFKA ML SUMMARY:")
