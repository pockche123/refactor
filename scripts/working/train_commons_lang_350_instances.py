#!/usr/bin/env python3
"""
Train Commons Lang ML model on 350-instance dataset
"""
...
def main():
    print("🚀 COMMONS LANG ML TRAINING (350 INSTANCES)")
    print("=" * 60)
    
    # Load 350-instance dataset
    print("📊 Loading Commons Lang 350-instance dataset...")
    df = pd.read_csv('data/commons_lang_simple_dataset_350.csv')
    ...
    print("💾 Saving model...")
    joblib.dump(rf, 'models/commons_lang_rf_model_350.pkl')
    joblib.dump(le_file, 'models/commons_lang_file_encoder_350.pkl')
    print("   ✅ models/commons_lang_rf_model_350.pkl")
    print("   ✅ models/commons_lang_file_encoder_350.pkl")
    ...
    results_file = 'results/working/commons_lang_ml_test_results_350.csv'
    results_df.to_csv(results_file, index=False)
    print(f"   ✅ {results_file}")
    
    # Detailed results
    print(f"\n📈 COMMONS LANG 350-INSTANCE RESULTS:")
