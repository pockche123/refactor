#!/usr/bin/env python3
"""
Train Kafka ML model on 350-instance dataset
"""
...
def main():
    print("🚀 KAFKA ML TRAINING (350 INSTANCES)")
    print("=" * 50)
    
    # Load 350-instance dataset
    print("📊 Loading Kafka 350-instance dataset...")
    df = pd.read_csv('data/kafka_simple_dataset_350.csv')
    ...
    print("💾 Saving model...")
    joblib.dump(rf, 'models/kafka_rf_model_350.pkl')
    joblib.dump(le_file, 'models/kafka_file_encoder_350.pkl')
    print("   ✅ models/kafka_rf_model_350.pkl")
    print("   ✅ models/kafka_file_encoder_350.pkl")
    ...
    results_file = 'results/working/kafka_ml_test_results_350.csv'
    results_df.to_csv(results_file, index=False)
    print(f"   ✅ {results_file}")
    
    # Detailed results
    print(f"\n📈 KAFKA 350-INSTANCE RESULTS:")
