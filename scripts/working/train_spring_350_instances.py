#!/usr/bin/env python3
"""
Train Spring Framework ML model on 350-instance dataset
"""
...
def main():
    print("🚀 SPRING FRAMEWORK ML TRAINING (350 INSTANCES)")
    print("=" * 60)
    
    # Load 350-instance dataset
    print("📊 Loading Spring Framework 350-instance dataset...")
    df = pd.read_csv('data/spring_simple_dataset_350.csv')
    ...
    print("💾 Saving model...")
    joblib.dump(rf, 'models/spring_rf_model_350.pkl')
    joblib.dump(le_file, 'models/spring_file_encoder_350.pkl')
    print("   ✅ models/spring_rf_model_350.pkl")
    print("   ✅ models/spring_file_encoder_350.pkl")
    ...
    results_file = 'results/working/spring_ml_test_results_350.csv'
    results_df.to_csv(results_file, index=False)
    print(f"   ✅ {results_file}")
    
    # Detailed results
    print(f"\n📈 SPRING FRAMEWORK 350-INSTANCE RESULTS:")
