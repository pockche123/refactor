...
public class SourceClassTest {
    ...
    @Test
    void testProcessData4() {
        // Test method functionality
        String result = sourceClass.processData4();
        assertNotNull(result);
        assertTrue(result.length() > 0);
    }
    
    @Test
    void testProcessData4Consistency() {
        // Test method returns consistent results
        String result1 = sourceClass.processData4();
        String result2 = sourceClass.processData4();
