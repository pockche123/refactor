#!/usr/bin/env python3
"""
Apache Kafka Refactoring Extraction
Extract refactorings from Kafka using RefactoringMiner
Following same methodology as other projects
"""
...
# Kafka repository path
KAFKA_PATH = "/Users/parjalrai/Workspace/kafka"

def get_commits_from_period(repo_path, start_date, end_date, max_commits=50):
...
def extract_refactorings_between_commits(start_commit, end_commit):
    ...
    try:
        ...
        temp_json = "/tmp/kafka_refactorings_temp.json"
        ...
        result = subprocess.run([
            ...
            '-bc', KAFKA_PATH, start_commit, end_commit, '-json', temp_json
        ],
        capture_output=True,
        text=True,
...
def main():
    print("🚀 APACHE KAFKA REFACTORING EXTRACTION")
    print("=" * 50)
    ...
    output_file = "data/kafka_refactorings.json"
