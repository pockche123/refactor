#!/usr/bin/env python3
"""
Create Apache Kafka dataset from RefactoringMiner JSON
...
def load_kafka_refactorings():
    """Load Kafka RefactoringMiner JSON"""
...
def main():
    print("🚀 APACHE KAFKA DATASET CREATION")
    print("=" * 50)
    
    # Load refactorings
    print("📊 Loading Kafka refactorings...")
    data = load_kafka_refactorings()
    ...
    behavioral_file = 'data/kafka_behavioral_dataset.csv'
    ...
    # Save simple dataset
    simple_file = 'data/kafka_simple_dataset.csv'
